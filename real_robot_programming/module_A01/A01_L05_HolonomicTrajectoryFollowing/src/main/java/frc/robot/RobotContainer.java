...
public class RobotContainer {
  ...
  private Optional<AutonomousStartContext> createDisabledStartContext() {
    ...
    Trajectory canonicalTrajectory = LearningTrajectoryFactory.createLearningTrajectory();
  ...
  private Command createAutonomousSession() {
    ...
    Command follower =
        new HolonomicTrajectoryFollowingCommand(
            swerveSubsystem, executionTrajectory, executionHeading, configuration, Timer::getFPGATimestamp);
    Command safetyHold =
