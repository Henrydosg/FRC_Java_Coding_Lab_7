...
final class PathPlannerExecutionPathFactory {
  ...
  static PathPlannerPath createExecutionPath(
    ...
    validateSupportedPath(canonicalPath, fieldVariant, alliance);
  ...
  private static void validateSupportedPath(
      PathPlannerPath path, FieldVariant fieldVariant, Alliance alliance) {
    ...
    if (path.getEventMarkers() == null || !path.getEventMarkers().isEmpty()) {
