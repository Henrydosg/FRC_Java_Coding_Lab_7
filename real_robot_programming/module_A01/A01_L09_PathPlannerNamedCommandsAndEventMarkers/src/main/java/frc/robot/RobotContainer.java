...
public class RobotContainer {
  ...
  private final AutonomousEventTelemetryFacade autonomousEventTelemetryFacade;
  ...
  public RobotContainer() {
    ...
    autonomousEventTelemetryFacade =
        new AutonomousEventTelemetryFacade(
            NetworkTableInstance.getDefault().getTable("Autonomous").getSubTable("Event"));
    AutonomousEventRegistration.register(
        new AutonomousEventBinding(
            AutonomousEventId.LEARNING_EVENT,
            () -> new AutonomousEventDemonstrationCommand(autonomousEventTelemetryFacade::publish),
            Set.of()),
        autonomousEventTelemetryFacade::publish);
