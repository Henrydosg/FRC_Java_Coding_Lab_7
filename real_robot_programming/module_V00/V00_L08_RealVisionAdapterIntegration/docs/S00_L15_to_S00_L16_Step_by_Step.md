...
- Verification: This historical record captured the previous calibration as FL
  `0.067138671875`, FR `0.02099609375`, BL `0.464599609375`, and BR `-0.052978515625`
  rotations. It is superseded by the later user-authoritative Phoenix Tuner X recalibration:
  FL `0.068603515625`, FR `0.014404296875`, BL `0.46240234375`, and BR `-0.057373046875`
  rotations.
- Expected Result: Current code and focused tests agree with the latest approved calibration;
  the previous values remain historical traceability only.
