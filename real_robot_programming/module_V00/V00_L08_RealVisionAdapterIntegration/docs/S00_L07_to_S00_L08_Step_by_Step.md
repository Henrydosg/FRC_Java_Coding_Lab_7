...
- Action: Use `driveVelocityRotationsPerSecond / 6.75 × (2π × wheelRadiusMeters)` with the verified 2.0-inch radius. The earlier 7.85:1 value was an initial provisional assumption and is obsolete historical data only.
- Files Changed: `src/main/java/frc/robot/subsystems/SwerveSubsystem.java`.
