...
public class SwerveModuleIOCTRE implements SwerveModuleIO {
  ...
  private static final double kSlot0GainFloat32ReadbackTolerance = 3.0e-8;
  /** Observed Phoenix kS readback quantization step, in volts. */
  private static final double kSlot0KsReadbackQuantizationStepVolts = 1.0 / 1024.0;
  /** Half-step tolerance accepts nearest-quantized kS without accepting adjacent bins. */
  private static final double kSlot0KsReadbackToleranceVolts =
      kSlot0KsReadbackQuantizationStepVolts / 2.0;
    ...
    if (closedLoopEnabled) {
      ...
      comparisons.add(
          ConfigurationFieldComparison.numeric(
              ...
              expected.Slot0.kS,
              actual.Slot0.kS,
              kSlot0KsReadbackToleranceVolts));
      comparisons.add(
          ConfigurationFieldComparison.numeric(
              "slot0KVMatches",
              expected.Slot0.kV,
  ...
  private static Slot0Configs createDriveSlot0Configuration() {
    return new Slot0Configs()
        ...
        .withKS(SwerveConstants.kDriveVelocitySlot0KsVolts)
        .withKV(SwerveConstants.kDriveVelocitySlot0KvVoltsPerRotationPerSecond)
        .withKA(SwerveConstants.kDriveVelocitySlot0KaVoltsPerRotationPerSecondSquared);
  }
