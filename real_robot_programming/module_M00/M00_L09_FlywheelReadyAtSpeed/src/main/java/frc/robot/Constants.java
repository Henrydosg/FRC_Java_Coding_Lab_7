...
public final class Constants {
  ...
  public static final class VisionConstants {
    ...
    /** Locked robot-to-camera Y translation, in meters. */
    public static final double kRobotToCameraYMeters = 0.050;

    /** Locked robot-to-camera Z translation, in meters. */
    public static final double kRobotToCameraZMeters = 0.114;

    /** Locked robot-to-camera roll, in radians. */
    public static final double kRobotToCameraRollRadians = 0.0;

    /** Locked robot-to-camera pitch, in radians. */
    public static final double kRobotToCameraPitchRadians = Units.degreesToRadians(-20.0);

    /** Locked robot-to-camera yaw, in radians. */
    public static final double kRobotToCameraYawRadians = 0.0;

    /** Immutable WPILib robot-to-camera mounting transform used by simulation. */
    public static final Transform3d kRobotToCamera =
        new Transform3d(
            kRobotToCameraXMeters,
            kRobotToCameraYMeters,
            kRobotToCameraZMeters,
            new Rotation3d(
  ...
  public static final class FlywheelConstants {
    /**
     * Provisional software-policy acceptance tolerance in Flywheel mechanism RPM.
     *
     * <p>This policy is NOT HARDWARE-TUNED and NOT REAL-ROBOT VALIDATED.
     */
    public static final double kReadyAtSpeedToleranceRpm = 50.0;
