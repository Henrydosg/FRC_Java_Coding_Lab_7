...
public final class FlywheelTelemetryFacade implements AutoCloseable {
  ...
  private final BooleanPublisher readyAtSpeedPublisher;
  ...
  public FlywheelTelemetryFacade(NetworkTable flywheelTable) {
    ...
    readyAtSpeedPublisher = requiredTable.getBooleanTopic("ReadyAtSpeed").publish();
  }
  ...
  public void publish(FlywheelObservation observation) {
    ...
    readyAtSpeedPublisher.set(requiredObservation.readyAtSpeed());
  }
