...
public interface VisionIO {
  ...
  class VisionIOInputs {
    ...
    /** True when the complete vendor-neutral timing result is structurally valid. */
    public boolean timingValid;

    /** Result-associated receive timestamp on the robot-compatible timebase, in seconds. */
    public double receiveTimestampSeconds;

    /** Complete camera-reported capture-to-receive latency, in seconds. */
