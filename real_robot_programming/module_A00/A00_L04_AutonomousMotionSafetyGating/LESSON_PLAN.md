...
This PASS is limited to A00_L04 autonomous-mode safety gating and lifecycle
behavior. It does not claim pose/localization, PathPlanner, AutoBuilder,
...
`PASS`; and the Transition Guide is `FINAL / PASS`. The supplied A00_L04
real-robot autonomous-mode safety-gating/lifecycle evidence is recorded as
`PASS`.
