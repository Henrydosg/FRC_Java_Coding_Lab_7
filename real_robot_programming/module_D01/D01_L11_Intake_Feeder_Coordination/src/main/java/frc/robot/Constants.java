...
public final class Constants {
  ...
  public static final class DriveConstants {
    public static final int kLeftLeaderCanId = 10;
    public static final int kLeftFollowerCanId = 7;
    public static final int kRightLeaderCanId = 11;
    public static final int kRightFollowerCanId = 8;
  ...
  public static final class IntakeConstants {
    ...
    public static final double kIntakeFeederDelaySeconds = 0.0;
  ...
  public static final class FeederConstants {
    ...
    public static final double kFeederAcquireOutput = 0.30;
    public static final double kFeederOuttakeOutput = -0.40;
    public static final double kFeederShootOutput = 0.40;
    public static final double kManualFeedOutput = 0.40;
  ...
  /**
   * Stores coordinated shooter command constants.
   */
  public static final class ShooterConstants {
    public static final double kFlywheelSpinUpDelaySeconds = 1.0;
