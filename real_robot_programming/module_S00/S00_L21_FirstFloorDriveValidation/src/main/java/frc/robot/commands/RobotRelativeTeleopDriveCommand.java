...
/** Converts one coherent driver-input sample into robot-relative Swerve velocity intent. */
public final class RobotRelativeTeleopDriveCommand extends Command {
  ...
  /**
   * Creates the robot-relative teleop command.
   *
   ...
   */
  public RobotRelativeTeleopDriveCommand(
  ...
  private RobotRelativeTeleopDriveCommand(
      SwerveSubsystem swerveSubsystem,
      XboxDriverInputSource driverInputSource,
      DriverInputTelemetryFacade driverInputTelemetryFacade,
      Consumer<DriverInputObservation> driverInputPublisher) {
  ...
  public void execute() {
    try {
      ...
      swerveSubsystem.acceptChassisSpeeds(robotRelativeSpeeds);
