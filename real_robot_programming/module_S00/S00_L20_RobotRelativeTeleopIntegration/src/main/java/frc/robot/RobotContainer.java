...
import frc.robot.commands.RobotRelativeTeleopDriveCommand;
...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    RobotRelativeTeleopDriveCommand robotRelativeTeleopDriveCommand =
        new RobotRelativeTeleopDriveCommand(
            swerveSubsystem,
            driverInputSource,
            driverInputTelemetryFacade);
    swerveSubsystem.setDefaultCommand(robotRelativeTeleopDriveCommand);
