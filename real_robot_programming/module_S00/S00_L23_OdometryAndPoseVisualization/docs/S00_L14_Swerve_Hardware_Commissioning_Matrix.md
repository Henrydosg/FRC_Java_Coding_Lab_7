...
| Drive ratio | 7.85:1 | 7.85:1 | 7.85:1 | 7.85:1 | VERIFIED - hardware map v2.0 and `kDriveGearRatio`. |
...
No provisional hardware identifiers, ratios, inversions, offsets, neutral modes, current limits,
ramp rates, bus values, or orientation values were invented.
